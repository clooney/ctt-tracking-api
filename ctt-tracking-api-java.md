CTT Tracking API - Java
================================
Use Java to track CTT shipments with CTT Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.ctt;
    ...
    public class CreateCttTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("ctt");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateCttTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetCttTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("ctt");
...
Update a tracking by ID:
    ...
    public class UpdateCttTrackingExample {
