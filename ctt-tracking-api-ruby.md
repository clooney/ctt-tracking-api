CTT Tracking API - Node.js
================================
Use Node.js to track CTT shipments with CTT Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"ctt"},{"tracking_number" => "LH290032509AU","courier_code"=>"ctt"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"ctt"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"ctt"}
